...
# group role_types
admin_group.roles.create    role_type: admin_role_type,   permittable: root_category, recursive: true
supermod_group.roles.create role_type: mod_role_type,     permittable: root_category, recursive: true
