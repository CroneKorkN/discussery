...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { group_id: @membership.group_id, member: @membership.member } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { group_id: @membership.group_id, member: @membership.member } }
